    ...
    @php
        $articles = [
            [
                ...
                'excerpt' => 'The Bontoc Information Technology Society website now gives students one place to access organization updates, project information, instructor profiles, officer details, articles, and student resources.',
                'meta' => 'Organization update',
                'read' => '3 min read',
                'status' => 'Featured',
                'date' => 'Aug 2026',
                'author' => 'BITS Publication Team',
                'tags' => ['Website', 'Students', 'Updates'],
            ],
            [
                'category' => 'Projects',
                'title' => 'BITS Connect Supports Student Records and Participation Tracking',
                'excerpt' => 'BITS Connect is an academic system built to help Information Technology students monitor participation, organize student records, and keep organization requirements easier to manage.',
                'meta' => 'BITS system',
                'read' => '4 min read',
                'status' => 'Working',
                'date' => 'Aug 2026',
            ...
            [
                'category' => 'Events',
                'title' => 'Programming Activities Prepare Students for Real Project Work',
                'excerpt' => 'Through programming activities and technical learning sessions, BITS helps students practice coding habits, interface design, system planning, and collaborative development.',
